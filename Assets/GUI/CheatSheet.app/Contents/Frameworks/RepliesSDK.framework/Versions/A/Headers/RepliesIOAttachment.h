...
+(instancetype)attachmentWithPromisedPath:(NSString *)path;
...
+(instancetype)attachmentWithPreferences;
+(instancetype)attachmentWithPreferencesForIdentifier:(NSString *)identifier;
